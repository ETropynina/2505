...
public class Theme6 extends AppCompatActivity {

    public int c = 0;
    String rightanswer1 = "48";
    String rightanswer2 = "36";
    String rightanswer3 = "996";
    String rightanswer4 = "67776";
    String rightanswer5 = "24";
