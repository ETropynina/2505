...
public class Theme5 extends AppCompatActivity {

    public int c = 0;
    String rightanswer1 = "12";
    String rightanswer2 = "134";
    String rightanswer3 = "34";
    String rightanswer4 = "24";
    String rightanswer5 = "14";
